...
<form method="POST" class="needs-validation" novalidate>
    ...
    <div class="alert alert-info">
        ...
        <ul class="mb-0">
            <li>База даних має бути створена заздалегідь</li>
            <li>Користувач повинен мати права на роботу з базою даних</li>
            <li>База даних має використовувати кодування UTF8MB4</li>
