        ...
        <div class="row justify-content-center align-items-center min-vh-100 py-5">
            <div class="col-12 col-md-10 col-lg-8 col-xl-5">
                <div class="modern-auth-card partner-login-card">
                    ...
                    <!-- Login Form -->
                    <form method="POST" id="modernPartnerLoginForm" class="modern-form" novalidate>
...
<script>
// Partner login specific functions
...
function showPasswordReset() {
    document.getElementById('modernPartnerLoginForm').style.display = 'none';
...
function hidePasswordReset() {
    document.getElementById('modernPartnerLoginForm').style.display = 'block';
    document.getElementById('passwordResetForm').style.display = 'none';
    document.querySelector('.auth-header h1').textContent = 'Партнерський вхід';
    document.querySelector('.auth-header p').textContent = 'Увійдіть до партнерського акаунту';
}
...
.partner-login-card .input-wrapper input:focus + .input-icon {
    color: var(--current-gradient);
}

.partner-login-card .input-line {
    background: var(--current-gradient);
}
