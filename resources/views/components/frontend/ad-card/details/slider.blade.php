    ...
    <div class="swiper galleryView">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href="{{ $ad->image_url }}" id='first' class="venobox w-full h-full flex justify-center"
                    data-gall="myGallery">
            ...
            @foreach ($ad->galleries as $gallery)
                <div class="swiper-slide">
                    <a href="{{ $gallery->image_url }}" class="venobox w-full h-full flex justify-center" data-gall="myGallery">
...
<div class="p-5">
    <div thumbsSlider="" class="swiper galleryList">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href="{{ $ad->image_url }}" data-gall="myGallery" class="venobox">
                    <img src="{{ $ad->image_url }}" />
                </a>
            </div>
            @foreach ($ad->galleries as $gallery)
                <div class="swiper-slide">
                    <a href="{{ $gallery->image_url }}" class="venobox" data-gall="myGallery">
