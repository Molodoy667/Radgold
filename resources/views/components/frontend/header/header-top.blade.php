...
.footer-touch-link:hover::before {
    left: 100%;
}
...
.footer-touch-link:hover .footer-icon-container {
    transform: scale(1.1) rotate(5deg);
...
.footer-touch-link:hover .footer-text {
...
.footer-touch-link:hover .footer-arrow {
    opacity: 1;
...
/* Glass Footer Touch Menu Styles */
.footer-menu-section {
    position: relative;
}
...
/* Dark theme support for glass footer */
...
/* Enhanced icon pulse animation for footer */
.footer-icon-pulse {
